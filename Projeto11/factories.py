...
class GridAdapter:
    ...
    def reserve_cell(self, coords, agent_id):
        self.reservations[coords] = agent_id

    def is_cell_reserved(self, coords, agent_id):
        res = self.reservations.get(coords)
        return res is not None and res != agent_id
